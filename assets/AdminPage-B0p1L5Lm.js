import{c as J,g as V,_ as Xe,a as Ye,b as Ze,i as xe,p as Je,d as Qe,e as et,F as tt,f as nt,C as st,r as re,S as at,h as rt,j as Q,u as it,k as ot,l as w,m as lt,n as s,L as ie,o as oe,q as le,s as ct,t as ye,P as ut,T as ve,v as dt,w as ht,x as F,y as mt,z as ce,A as pt,B as gt,D as ft,E as X,G as ue,H as bt,I as _t,J as xt,K as yt,M as Ne,N as vt,O as Nt}from"./index-B7ofnadJ.js";/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=J("CloudUpload",[["path",{d:"M12 13v8",key:"1l5pq0"}],["path",{d:"M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242",key:"1pljnt"}],["path",{d:"m8 17 4-4 4 4",key:"1quai1"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const he=J("ImagePlus",[["path",{d:"M16 5h6",key:"1vod17"}],["path",{d:"M19 2v6",key:"4bpg5p"}],["path",{d:"M21 11.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7.5",key:"1ue2ih"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(e){return e!==void 0}function Vt(e){return typeof e=="object"&&!Array.isArray(e)}function te(e){return typeof e=="string"||e instanceof String}function me(e){return ne()&&e instanceof Blob}function ne(){return typeof Blob<"u"}function pe(e,t,n,a){if(a<t)throw Y(`Invalid value for '${e}'. Expected ${t} or greater.`);if(a>n)throw Y(`Invalid value for '${e}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function se(e,t,n){let a=t;return n==null&&(a=`https://${t}`),`${n}://${a}/v0${e}`}function Te(e){const t=encodeURIComponent;let n="?";for(const a in e)if(e.hasOwnProperty(a)){const r=t(a)+"="+t(e[a]);n=n+r+"&"}return n=n.slice(0,-1),n}var I;(function(e){e[e.NO_ERROR=0]="NO_ERROR",e[e.NETWORK_ERROR=1]="NETWORK_ERROR",e[e.ABORT=2]="ABORT"})(I||(I={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zt(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function Jt(...e){const t=Zt();if(t!==void 0){const n=new t;for(let a=0;a<e.length;a++)n.append(e[a]);return n.getBlob()}else{if(ne())return new Blob(e);throw new N(v.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function Qt(e,t,n){return e.webkitSlice?e.webkitSlice(t,n):e.mozSlice?e.mozSlice(t,n):e.slice?e.slice(t,n):null}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S{constructor(t,n){let a=0,r="";me(t)?(this.data_=t,a=t.size,r=t.type):t instanceof ArrayBuffer?(n?this.data_=new Uint8Array(t):(this.data_=new Uint8Array(t.byteLength),this.data_.set(new Uint8Array(t))),a=this.data_.length):t instanceof Uint8Array&&(n?this.data_=t:(this.data_=new Uint8Array(t.length),this.data_.set(t)),a=t.length),this.size_=a,this.type_=r}size(){return this.size_}type(){return this.type_}slice(t,n){if(me(this.data_)){const a=this.data_,r=Qt(a,t,n);return r===null?null:new S(r)}else{const a=new Uint8Array(this.data_.buffer,t,n-t);return new S(a,!0)}}static getBlob(...t){if(ne()){const n=t.map(a=>a instanceof S?a.data_:a);return new S(Jt.apply(null,n))}else{const n=t.map(l=>te(l)?tn(E.RAW,l).data:l.data_);let a=0;n.forEach(l=>{a+=l.byteLength});const r=new Uint8Array(a);let o=0;return n.forEach(l=>{for(let u=0;u<l.length;u++)r[o++]=l[u]}),new S(r,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(t,n){this._service=t,n instanceof D?this._location=n:this._location=D.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new U(t,n)}get root(){const t=new D(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Ae(this._location.path)}get storage(){return this._service}get parent(){const t=on(this._location.path);if(t===null)return null;const n=new D(this._location.bucket,t);return new U(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Mt(t)}}function jn(e,t,n){e._throwIfRoot("uploadBytes");const a=vn(e.storage,e._location,Se(),new S(t,!0),n);return e.storage.makeRequestWithTokens(a,Me).then(r=>({metadata:r,ref:e}))}function Rn(e){e._throwIfRoot("getDownloadURL");const t=_n(e.storage,e._location,Se());return e.storage.makeRequestWithTokens(t,Me).then(n=>{if(n===null)throw Ot();return n})}function kn(e,t){const n=ln(e._location.path,t),a=new D(e._location.bucket,n);return new U(e.storage,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(e){return/^[A-Za-z]+:\/\//.test(e)}function Cn(e,t){return new U(e,t)}function Fe(e,t){if(e instanceof ae){const n=e;if(n._bucket==null)throw It();const a=new U(n,n._bucket);return t!=null?Fe(a,t):a}else return t!==void 0?kn(e,t):e}function Dn(e,t){if(t&&Tn(t)){if(e instanceof ae)return Cn(e,t);throw Y("To use ref(service, url), the first argument must be a Storage instance.")}else return Fe(e,t)}function ge(e,t){const n=t==null?void 0:t[Re];return n==null?null:D.makeFromBucketSpec(n,e)}function Pn(e,t,n,a={}){e.host=`${t}:${n}`;const r=xe(t);r&&Je(`https://${e.host}/b`),e._isUsingEmulator=!0,e._protocol=r?"https":"http";const{mockUserToken:o}=a;o&&(e._overrideAuthToken=typeof o=="string"?o:Qe(o,e.app.options.projectId))}class ae{constructor(t,n,a,r,o,l=!1){this.app=t,this._authProvider=n,this._appCheckProvider=a,this._url=r,this._firebaseVersion=o,this._isUsingEmulator=l,this._bucket=null,this._host=je,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=wt,this._maxUploadRetryTime=jt,this._requests=new Set,r!=null?this._bucket=D.makeFromBucketSpec(r,this._host):this._bucket=ge(this._host,this.app.options)}get host(){return this._host}set host(t){this._host=t,this._url!=null?this._bucket=D.makeFromBucketSpec(this._url,t):this._bucket=ge(t,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(t){pe("time",0,Number.POSITIVE_INFINITY,t),this._maxUploadRetryTime=t}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(t){pe("time",0,Number.POSITIVE_INFINITY,t),this._maxOperationRetryTime=t}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const t=this._authProvider.getImmediate({optional:!0});if(t){const n=await t.getToken();if(n!==null)return n.accessToken}return null}async _getAppCheckToken(){if(et(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const t=this._appCheckProvider.getImmediate({optional:!0});return t?(await t.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(t=>t.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(t){return new U(this,t)}_makeRequest(t,n,a,r,o=!0){if(this._deleted)return new Ft(ke());{const l=Yt(t,this._appId,a,r,n,this._firebaseVersion,o,this._isUsingEmulator);return this._requests.add(l),l.getPromise().then(()=>this._requests.delete(l),()=>this._requests.delete(l)),l}}async makeRequestWithTokens(t,n){const[a,r]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(t,n,a,r).getPromise()}}const fe="@firebase/storage",be="0.14.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Be="storage";function En(e,t,n){return e=V(e),jn(e,t,n)}function An(e){return e=V(e),Rn(e)}function Sn(e,t){return e=V(e),Dn(e,t)}function In(e=Ze(),t){e=V(e);const a=Xe(e,Be).getImmediate({identifier:t}),r=Ye("storage");return r&&Un(a,...r),a}function Un(e,t,n,a={}){Pn(e,t,n,a)}function On(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),a=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new ae(n,a,r,t,at)}function Ln(){nt(new st(Be,On,"PUBLIC").setMultipleInstances(!0)),re(fe,be,""),re(fe,be,"esm2020")}Ln();function $e(e){return/^https?:\/\//.test(e)||/^data:image\//.test(e)}function Mn({image:e,onRemove:t}){const[n,a]=w.useState(!1);return s.jsxs("figure",{children:[n?s.jsx("div",{className:"admin-image-fallback",children:"Imagen no disponible"}):s.jsx("img",{src:e,alt:"",onError:()=>a(!0)}),s.jsx("button",{type:"button",onClick:t,children:"Quitar"})]})}const Fn=["Excelente","Muy bueno","Bueno","Delicado"],Bn=["Disponible","Consultar","Reservado"],$n=["brass","green","red","blue","paper","copper"],K={id:"",name:"",category:"Utilería",tags:"",rentalPricePerDay:"",rentalPricePerWeek:"",description:"",curiosities:"",status:"Excelente",measurements:"",material:"",color:"",eraStyle:"",availability:"Disponible",estimatedValue:"",guaranteePercentage:"0.3",minimumDeposit:"",featuredScore:"50",internalNotes:"",images:[],visualTone:"paper",visualSigil:"✶"};function zn(e){return{id:e.id,name:e.name,category:e.category,tags:e.tags.join(", "),rentalPricePerDay:String(e.rentalPricePerDay),rentalPricePerWeek:e.rentalPricePerWeek?String(e.rentalPricePerWeek):"",description:e.description,curiosities:e.curiosities,status:e.status,measurements:e.measurements,material:e.material,color:e.color,eraStyle:e.eraStyle,availability:e.availability,estimatedValue:String(e.estimatedValue),guaranteePercentage:String(e.guaranteePercentage),minimumDeposit:String(e.minimumDeposit),featuredScore:String(e.featuredScore),internalNotes:e.internalNotes??"",images:e.images.filter($e),visualTone:e.visual.tone,visualSigil:e.visual.sigil}}function L(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Vn(e){const t=e.rentalPricePerWeek.trim(),n=e.internalNotes.trim(),a={id:e.id.trim(),name:e.name.trim(),category:e.category,tags:e.tags.split(",").map(r=>r.trim()).filter(Boolean),rentalPricePerDay:L(e.rentalPricePerDay),description:e.description.trim(),curiosities:e.curiosities.trim(),status:e.status,measurements:e.measurements.trim(),material:e.material.trim(),color:e.color.trim(),eraStyle:e.eraStyle.trim(),availability:e.availability,estimatedValue:L(e.estimatedValue),guaranteePercentage:L(e.guaranteePercentage,.3),minimumDeposit:L(e.minimumDeposit),featuredScore:L(e.featuredScore,50),images:e.images.filter($e),visual:{tone:e.visualTone,sigil:e.visualSigil.trim()||"✶"}};return t&&(a.rentalPricePerWeek=L(t)),n&&(a.internalNotes=n),a}function qn(e){return e.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,"")}function Hn(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-zA-Z0-9._-]+/g,"-")}const Wn=["Lun","Mar","Mié","Jue","Vie","Sáb","Dom"];function Z(e){return new Date(e.getFullYear(),e.getMonth(),1)}function _e(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function Gn(e){const t=Z(e),n=(t.getDay()+6)%7,a=new Date(t);return a.setDate(t.getDate()-n),Array.from({length:42},(r,o)=>{const l=new Date(a);return l.setDate(a.getDate()+o),{iso:X(l),inMonth:l.getMonth()===t.getMonth()}})}function Kn(e){return new Intl.DateTimeFormat("es-AR",{month:"long",year:"numeric"}).format(e)}function Xn({reservation:e,productName:t,profile:n,onMessage:a}){const r=Q(),[o,l]=w.useState(e.startDate),[u,m]=w.useState(e.endDate),[g,x]=w.useState(String(e.quantity??1)),[R,j]=w.useState(e.note??""),[c,y]=w.useState(!1),d=async()=>{if(!r||e.source!=="firebase"){a("Esta reserva no se puede editar desde el panel porque no viene de Firestore.");return}if(!o||!u||u<o){a("Revisá las fechas de la reserva antes de guardar.");return}try{y(!0),await vt(F(r,"reservations",e.id),{startDate:o,endDate:u,quantity:Math.max(1,Number(g)||1),rentalDays:Nt(o,u),note:R.trim()}),a(`Reserva actualizada: ${t}`)}catch(p){console.error(p);const f=p;a(`No se pudo actualizar la reserva (${f.code??"error desconocido"}). ${f.message??"Revisá tus permisos de admin."}`)}finally{y(!1)}},h=async()=>{if(!r||e.source!=="firebase"){a("Esta reserva no se puede borrar desde el panel porque no viene de Firestore.");return}if(window.confirm(`¿Borrar la reserva de ${t}?`))try{y(!0),await Ne(F(r,"reservations",e.id)),a(`Reserva borrada: ${t}`)}catch(p){console.error(p);const f=p;a(`No se pudo borrar la reserva (${f.code??"error desconocido"}). ${f.message??"Revisá tus permisos de admin."}`)}finally{y(!1)}};return s.jsxs("article",{className:"admin-reservation-row",children:[s.jsxs("div",{children:[s.jsx("strong",{children:t}),s.jsx("span",{children:n?`${n.firstName} ${n.lastName}`:e.customerName||e.customerEmail||"Cliente sin datos visibles"}),n&&s.jsxs("span",{children:["DNI: ",n.dni]}),n&&s.jsxs("span",{children:["Celular: ",n.phone]}),(n==null?void 0:n.email)&&s.jsx("span",{children:n.email})]}),s.jsxs("div",{className:"admin-reservation-fields",children:[s.jsxs("label",{children:["Desde",s.jsx("input",{className:"gabinete-input",type:"date",value:o,onChange:p=>l(p.target.value)})]}),s.jsxs("label",{children:["Hasta",s.jsx("input",{className:"gabinete-input",type:"date",value:u,onChange:p=>m(p.target.value)})]}),s.jsxs("label",{children:["Cant.",s.jsx("input",{className:"gabinete-input",type:"number",min:"1",value:g,onChange:p=>x(p.target.value)})]})]}),s.jsxs("label",{className:"admin-reservation-note",children:["Nota",s.jsx("input",{className:"gabinete-input",value:R,onChange:p=>j(p.target.value)})]}),s.jsxs("div",{className:"admin-reservation-actions",children:[s.jsxs("button",{type:"button",className:"gabinete-button-secondary",onClick:h,disabled:c,children:[s.jsx(ve,{size:16}),"Borrar"]}),s.jsxs("button",{type:"button",className:"gabinete-button",onClick:d,disabled:c,children:[s.jsx(we,{size:16}),c?"Guardando...":"Guardar"]})]})]})}function Yn({products:e}){const{reservations:t,syncMode:n}=pt(),[a,r]=w.useState(""),[o,l]=w.useState([]),[u,m]=w.useState(()=>Z(gt(ft()))),g=w.useMemo(()=>Gn(u),[u]),x=w.useMemo(()=>new Map(e.map(d=>[d.id,d])),[e]),R=w.useMemo(()=>new Map(o.map(d=>[d.uid,d])),[o]),j=X(Z(u)),c=X(new Date(u.getFullYear(),u.getMonth()+1,0)),y=w.useMemo(()=>t.filter(d=>ue(j,c,d.startDate,d.endDate)).sort((d,h)=>d.startDate.localeCompare(h.startDate)||d.productId.localeCompare(h.productId)),[c,j,t]);return w.useEffect(()=>{const d=Q();if(d)return bt(_t(d,"userProfiles"),h=>{l(h.docs.map(p=>p.data()))})},[]),s.jsxs("section",{className:"admin-reservations parchment-panel",children:[s.jsxs("div",{className:"admin-reservations-head",children:[s.jsxs("div",{children:[s.jsxs("p",{className:"eyebrow flex items-center gap-2",children:[s.jsx(ye,{size:15}),"Calendario admin"]}),s.jsx("h2",{children:"Pedidos y alquileres por fecha"}),s.jsxs("p",{children:["Fuente de reservas: ",n==="firebase"?"Firestore":"local",". Cada marca bloquea el objeto para futuros clientes."]})]}),s.jsxs("div",{className:"calendar-month-bar admin-calendar-nav",children:[s.jsx("button",{type:"button",onClick:()=>m(d=>_e(d,-1)),children:s.jsx(xt,{size:18})}),s.jsx("strong",{children:Kn(u)}),s.jsx("button",{type:"button",onClick:()=>m(d=>_e(d,1)),children:s.jsx(yt,{size:18})})]})]}),s.jsxs("div",{className:"admin-calendar-grid",children:[Wn.map(d=>s.jsx("span",{className:"calendar-weekday",children:d},d)),g.map(({iso:d,inMonth:h})=>{const p=t.filter(f=>ue(d,d,f.startDate,f.endDate));return s.jsxs("div",{className:`admin-calendar-day ${h?"":"is-outside"} ${p.length>0?"has-reservations":""}`,children:[s.jsx("span",{className:"admin-calendar-number",children:Number(d.slice(-2))}),p.slice(0,2).map(f=>{const k=x.get(f.productId);return s.jsx("span",{className:"admin-calendar-chip",title:(k==null?void 0:k.name)??f.productId,children:(k==null?void 0:k.name)??f.productId},f.id)}),p.length>2&&s.jsxs("span",{className:"admin-calendar-more",children:["+",p.length-2]})]},d)})]}),s.jsxs("div",{className:"admin-reservation-list",children:[s.jsx("p",{className:"eyebrow",children:"Reservas del mes"}),a&&s.jsx("p",{className:"admin-message",children:a}),y.length===0?s.jsx("p",{className:"admin-empty-reservations",children:"No hay objetos alquilados o pedidos para este mes."}):y.map(d=>{const h=x.get(d.productId);return s.jsx(Xn,{reservation:d,productName:(h==null?void 0:h.name)??d.productId,profile:d.createdByUid?R.get(d.createdByUid):void 0,onMessage:r},d.id)})]})]})}function Jn(){const e=rt(),t=Q(),n=e?In(e):null,{user:a,isAdmin:r,checkingAdmin:o,loginWithGoogle:l,logout:u,authError:m}=it(),{products:g,syncMode:x}=ot(),[R,j]=w.useState(""),[c,y]=w.useState(K),[d,h]=w.useState(""),[p,f]=w.useState(!1),[k,T]=w.useState(!1),[A,O]=w.useState("reservations"),q=w.useMemo(()=>[...g].sort((i,_)=>i.name.localeCompare(_.name)),[g]),b=(i,_)=>{y(P=>({...P,[i]:_}))},ze=async i=>{i.preventDefault(),h(""),await l()},Ve=()=>{y({...K,id:`EG-${String(g.length+1).padStart(3,"0")}`}),h("")},qe=async i=>{if(i.preventDefault(),!t||!r)return;const _=Vn(c);if(!_.id||!_.name){h("Completá ID y nombre antes de guardar.");return}try{f(!0),await ce(F(t,"products",_.id),_),h(`Producto guardado: ${_.name}`)}catch(P){console.error(P);const H=P;h(`No se pudo guardar el producto (${H.code??"error desconocido"}). ${H.message??"Revisá los datos cargados y tus permisos de admin."}`)}finally{f(!1)}},He=async()=>{!t||!r||!c.id||!window.confirm(`¿Eliminar ${c.name||c.id}?`)||(f(!0),await Ne(F(t,"products",c.id)),f(!1),y(K),h("Producto eliminado."))},We=()=>{const i=R.trim();if(!/^https?:\/\//.test(i)){h("Pegá una URL pública de imagen que empiece con http o https.");return}b("images",[i,...c.images]),j(""),h("Imagen agregada. Guardá el producto para conservarla en el catálogo.")},Ge=async i=>{if(!i||!n||!c.id){h("Completá el ID antes de subir imágenes.");return}try{T(!0);const _=Sn(n,`products/${c.id}/${Date.now()}-${Hn(i.name)}`);await En(_,i,{contentType:i.type});const P=await An(_);b("images",[P,...c.images]),h("Imagen subida. Guardá el producto para conservarla en el catálogo.")}catch(_){console.error(_);const P=_;h(`No se pudo subir la imagen (${P.code??"error desconocido"}). ${P.message??"Revisá las reglas de Storage y tus permisos de admin."}`)}finally{T(!1)}},Ke=async()=>{if(!(!t||!r||!window.confirm("¿Restaurar en Firestore los productos base que falten? No se pisan productos ya editados.")))try{f(!0);let i=0;await Promise.all(ht.map(async _=>{const P=F(t,"products",_.id);(await mt(P)).exists()||(await ce(P,_),i+=1)})),h(i>0?`Catálogo base restaurado. Se agregaron ${i} productos.`:"Firestore ya tenía todos los productos base.")}catch(i){console.error(i);const _=i;h(`No se pudo restaurar el catálogo base (${_.code??"error desconocido"}). ${_.message??"Revisá tus permisos de admin."}`)}finally{f(!1)}};return!lt||!t?s.jsx("section",{className:"admin-page",children:s.jsxs("div",{className:"admin-card",children:[s.jsx("p",{className:"eyebrow",children:"Admin"}),s.jsx("h1",{children:"Firebase no está configurado"}),s.jsx("p",{children:"Cargá las variables de Firebase para habilitar el panel."})]})}):a?o?s.jsx("section",{className:"admin-page",children:s.jsx("div",{className:"admin-card",children:"Verificando permisos..."})}):r?s.jsxs("section",{className:"admin-page",children:[s.jsxs("div",{className:"admin-head",children:[s.jsxs("div",{children:[s.jsx("p",{className:"eyebrow",children:"Admin"}),s.jsx("h1",{children:"Panel"}),s.jsxs("p",{children:["Fuente actual: ",x==="firebase"?"Firestore":"catálogo local de respaldo"]})]}),s.jsxs("div",{className:"admin-actions",children:[s.jsxs("button",{type:"button",className:"gabinete-button-secondary",onClick:Ke,disabled:p,children:[s.jsx(de,{size:17}),"Restaurar catálogo base"]}),s.jsxs("button",{type:"button",className:"gabinete-button-secondary",onClick:u,children:[s.jsx(le,{size:17}),"Salir"]})]})]}),d&&s.jsxs("p",{className:"admin-message",children:[s.jsx(ct,{size:16}),d]}),s.jsxs("div",{className:"admin-tabs",role:"tablist","aria-label":"Secciones del panel",children:[s.jsxs("button",{type:"button",className:A==="reservations"?"is-active":"",onClick:()=>O("reservations"),children:[s.jsx(ye,{size:16}),"Calendario y reservas"]}),s.jsxs("button",{type:"button",className:A==="catalog"?"is-active":"",onClick:()=>O("catalog"),children:[s.jsx(de,{size:16}),"Actualización del catálogo"]})]}),A==="reservations"&&s.jsx(Yn,{products:g}),A==="catalog"&&s.jsxs("div",{className:"admin-layout",children:[s.jsxs("aside",{className:"admin-list",children:[s.jsxs("button",{type:"button",className:"admin-new-button",onClick:Ve,children:[s.jsx(ut,{size:16}),"Nuevo producto"]}),q.map(i=>s.jsxs("button",{type:"button",className:c.id===i.id?"is-active":"",onClick:()=>y(zn(i)),children:[s.jsx("strong",{children:i.name}),s.jsxs("span",{children:[i.id," · ",i.category]})]},i.id))]}),s.jsxs("form",{onSubmit:qe,className:"admin-editor",children:[s.jsxs("div",{className:"admin-editor-title",children:[s.jsxs("div",{children:[s.jsx("p",{className:"eyebrow",children:"Ficha editable"}),s.jsx("h2",{children:c.name||"Producto nuevo"})]}),s.jsxs("div",{className:"admin-actions",children:[s.jsxs("button",{type:"button",className:"gabinete-button-secondary",onClick:He,disabled:!c.id||p,children:[s.jsx(ve,{size:17}),"Eliminar"]}),s.jsxs("button",{type:"submit",className:"gabinete-button",disabled:p,children:[s.jsx(we,{size:17}),p?"Guardando...":"Guardar"]})]})]}),s.jsxs("div",{className:"admin-grid",children:[s.jsxs("label",{children:["ID",s.jsx("input",{className:"gabinete-input",value:c.id,onChange:i=>b("id",qn(i.target.value).toUpperCase())})]}),s.jsxs("label",{children:["Nombre",s.jsx("input",{className:"gabinete-input",value:c.name,onChange:i=>b("name",i.target.value)})]}),s.jsxs("label",{children:["Categoría",s.jsx("select",{className:"gabinete-input",value:c.category,onChange:i=>b("category",i.target.value),children:dt.map(i=>s.jsx("option",{children:i},i))})]}),s.jsxs("label",{children:["Estado",s.jsx("select",{className:"gabinete-input",value:c.status,onChange:i=>b("status",i.target.value),children:Fn.map(i=>s.jsx("option",{children:i},i))})]}),s.jsxs("label",{children:["Disponibilidad",s.jsx("select",{className:"gabinete-input",value:c.availability,onChange:i=>b("availability",i.target.value),children:Bn.map(i=>s.jsx("option",{children:i},i))})]}),s.jsxs("label",{children:["Precio diario",s.jsx("input",{className:"gabinete-input",type:"number",value:c.rentalPricePerDay,onChange:i=>b("rentalPricePerDay",i.target.value)})]}),s.jsxs("label",{children:["Precio semanal",s.jsx("input",{className:"gabinete-input",type:"number",value:c.rentalPricePerWeek,onChange:i=>b("rentalPricePerWeek",i.target.value)})]}),s.jsxs("label",{children:["Valor estimado",s.jsx("input",{className:"gabinete-input",type:"number",value:c.estimatedValue,onChange:i=>b("estimatedValue",i.target.value)})]}),s.jsxs("label",{children:["Garantía %",s.jsx("input",{className:"gabinete-input",type:"number",step:"0.01",value:c.guaranteePercentage,onChange:i=>b("guaranteePercentage",i.target.value)})]}),s.jsxs("label",{children:["Depósito mínimo",s.jsx("input",{className:"gabinete-input",type:"number",value:c.minimumDeposit,onChange:i=>b("minimumDeposit",i.target.value)})]}),s.jsxs("label",{children:["Destacado",s.jsx("input",{className:"gabinete-input",type:"number",value:c.featuredScore,onChange:i=>b("featuredScore",i.target.value)})]}),s.jsxs("label",{children:["Tags",s.jsx("input",{className:"gabinete-input",value:c.tags,onChange:i=>b("tags",i.target.value),placeholder:"vintage, cine, oficina"})]}),s.jsxs("label",{children:["Medidas",s.jsx("input",{className:"gabinete-input",value:c.measurements,onChange:i=>b("measurements",i.target.value)})]}),s.jsxs("label",{children:["Material",s.jsx("input",{className:"gabinete-input",value:c.material,onChange:i=>b("material",i.target.value)})]}),s.jsxs("label",{children:["Color",s.jsx("input",{className:"gabinete-input",value:c.color,onChange:i=>b("color",i.target.value)})]}),s.jsxs("label",{children:["Época / estilo",s.jsx("input",{className:"gabinete-input",value:c.eraStyle,onChange:i=>b("eraStyle",i.target.value)})]}),s.jsxs("label",{children:["Tono visual",s.jsx("select",{className:"gabinete-input",value:c.visualTone,onChange:i=>b("visualTone",i.target.value),children:$n.map(i=>s.jsx("option",{children:i},i))})]}),s.jsxs("label",{children:["Símbolo",s.jsx("input",{className:"gabinete-input",value:c.visualSigil,onChange:i=>b("visualSigil",i.target.value)})]})]}),s.jsxs("label",{className:"admin-wide",children:["Descripción",s.jsx("textarea",{className:"gabinete-input",rows:4,value:c.description,onChange:i=>b("description",i.target.value)})]}),s.jsxs("label",{className:"admin-wide",children:["Curiosidades",s.jsx("textarea",{className:"gabinete-input",rows:3,value:c.curiosities,onChange:i=>b("curiosities",i.target.value)})]}),s.jsxs("label",{className:"admin-wide",children:["Notas internas",s.jsx("textarea",{className:"gabinete-input",rows:3,value:c.internalNotes,onChange:i=>b("internalNotes",i.target.value)})]}),s.jsxs("div",{className:"admin-images",children:[s.jsxs("label",{className:"admin-upload",children:[s.jsx(he,{size:18}),k?"Subiendo...":"Subir archivo",s.jsx("input",{type:"file",accept:"image/*",onChange:i=>{var _;return Ge((_=i.target.files)==null?void 0:_[0])}})]}),s.jsxs("div",{className:"admin-image-url",children:[s.jsxs("label",{children:["URL pública de imagen",s.jsx("input",{className:"gabinete-input",value:R,onChange:i=>j(i.target.value),placeholder:"https://..."})]}),s.jsxs("button",{type:"button",className:"admin-upload",onClick:We,children:[s.jsx(he,{size:18}),"Agregar imagen"]})]}),s.jsx("div",{className:"admin-image-grid",children:c.images.map(i=>s.jsx(Mn,{image:i,onRemove:()=>b("images",c.images.filter(_=>_!==i))},i))})]})]})]})]}):s.jsx("section",{className:"admin-page",children:s.jsxs("div",{className:"admin-card",children:[s.jsx("p",{className:"eyebrow",children:"Sin permiso"}),s.jsx("h1",{children:"Tu usuario no es administrador"}),s.jsxs("p",{children:["Pedí que agreguen este email en Firestore: ",s.jsx("strong",{children:a.email})]}),s.jsxs("button",{type:"button",className:"gabinete-button-secondary",onClick:u,children:[s.jsx(le,{size:17}),"Salir"]})]})}):s.jsx("section",{className:"admin-page",children:s.jsxs("form",{onSubmit:ze,className:"admin-card admin-login",children:[s.jsx("span",{className:"admin-lock",children:s.jsx(ie,{size:22})}),s.jsx("p",{className:"eyebrow",children:"Admin"}),s.jsx("h1",{children:"Ingresar al catálogo"}),s.jsx("p",{children:"Usá la cuenta de Google autorizada para editar productos y administrar el catálogo."}),s.jsxs("div",{className:"admin-auth-debug",children:[s.jsxs("p",{children:[s.jsx("strong",{children:"Dominio actual:"})," ",window.location.hostname]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Auth domain:"})," ",oe.authDomain||"sin configurar"]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Project ID:"})," ",oe.projectId||"sin configurar"]})]}),(d||m)&&s.jsx("p",{className:"admin-message",children:d||m}),s.jsxs("button",{type:"submit",className:"gabinete-button",children:[s.jsx(ie,{size:17}),"Entrar con Google"]})]})})}export{Jn as AdminPage};
